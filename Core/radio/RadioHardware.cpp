...
{
    TracePrintln(TAG, "");
    // Preserve the hardware state across normal Soapy device teardown.
    // SDR++ destroys and recreates the device between stream sessions;
    // asserting SHDWN here leaves the replacement instance unable to stream.
}